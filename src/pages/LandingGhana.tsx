  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(FORMSPREE_ENDPOINT, {
        ...
        body: JSON.stringify({ ...formData, market: "Ghana" }),
      });
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-primary text-primary-foreground">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 50%, hsl(43 96% 56%) 0%, transparent 60%), radial-gradient(circle at 80% 20%, hsl(10 80% 50%) 0%, transparent 50%)",
          }}
        />
        <Section>
          <div className="w-full max-w-[80rem] mx-auto relative z-10 text-center">
            ...
            <AppearOnScroll delay={150}>
              <p className="text-[1.8rem] md:text-[2.2rem] text-primary-foreground/80 max-w-[60rem] mx-auto leading-[1.6]">
                Be among the first to access Ghana's premium legal subscription platform. Connect with vetted lawyers and attorneys across every practice area.
              </p>
            </AppearOnScroll>
          </div>
        </Section>
            ...
            <AppearOnScroll delay={0}>
              <div className="text-center mb-10">
                ...
                <p className="text-[1.7rem] text-muted-foreground leading-[1.8]">
                  Be first in line when we launch in Ghana. No spam, just launch news.
                </p>
              </div>
            </AppearOnScroll>
              ...
              <AppearOnScroll delay={0}>
                <div className="bg-card border border-border rounded-2xl p-12 text-center">
                  ...
                  <p className="text-[1.6rem] text-muted-foreground leading-[1.8]">
                    We'll notify you as soon as Monogamy launches in Ghana on 1 May 2026.
                  </p>
                </div>
              </AppearOnScroll>
            ) : (
              <AppearOnScroll delay={50}>
                <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-8 md:p-12 flex flex-col gap-6">
                  <div className="flex flex-col gap-2">
                    <label className="text-[1.5rem] font-medium" htmlFor="gh-name">Full Name</label>
                    <input
                      id="gh-name"
                      name="name"
                      type="text"
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[1.5rem] font-medium" htmlFor="gh-email">Email Address</label>
                    <input
                      id="gh-email"
                      name="email"
                      type="email"
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[1.5rem] font-medium" htmlFor="gh-phone">Phone Number</label>
                    <input
                      id="gh-phone"
                      name="phone"
                      type="tel"
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[1.5rem] font-medium" htmlFor="gh-category">I am a…</label>
                    <select
                      id="gh-category"
                      name="category"
                      required
